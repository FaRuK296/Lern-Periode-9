...
Heute habe ich mich mit der Back-End-Technologie Node.js und Express beschäftigt, um eine Ergänzung zu meinem bestehenden TypeScript-Frontend aus der letzten Lernperiode zu entwickeln.
...
Ich musste mein Rock-Paper-Scissors-Frontend ändern, indem ich eine fetch() erstellt habe, welche Anfragen an meinen Express-Server sendet und die Antwort in der Browser-Konsole anzeigt.
